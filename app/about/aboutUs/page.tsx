        ...
        <div className="page-body">
            <div className="sidebar1">
                <div className="sidebar2" id="sidebar">
                    ...
                    <hr className="complete" />
                    <div style="height: 200px; background-color: brown;"></div>
                    ...
                    <hr className="complete" />
                    <p className="reach">Email: <a href="mailto:office@iiitkalyani.ac.in" target="_blank">office@iiitkalyani.ac.in</a></p>
                </div>
            </div>
