      ...
      details: [
        {
          id: 1,
          label:
            "Master’s degree in Engineering/Technologyin a relevant area with a minimum CGPA of 6.5 or 60% of marks.",
        },
        {
          id: 2,
          label:
      ...
      details: [
        {
          id: 1,
          label:
            "Master's degree in Arts/Commerce/Science in a relevant area with a minimum of 55% marks or equivalent of marks or Master's degree in Engineering/Technology in a relevant area with a minimum CPI of 6.5or 60% of marks.",
        },
      ],
    },
    {
      ...
      forinfo:
        "For Sponsored, Part-Time and External Categories, a candidate must satisfy the following criteria:",
      details: [
        {
          id: 1,
          label:
            "Candidate in Sponsored, Part-time and External categories must be a regular employee of the sponsoring organization with at least one year of professional experience in the respective field.",
        },
      ],
    },
  ],
