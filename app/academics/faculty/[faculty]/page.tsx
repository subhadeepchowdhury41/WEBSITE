    ...
    return (
        <>
            <div className='fluid-center fac-main-page'>
                <div className='fluid-center fac-info'>
                    <div className="fluid-center  mx-4  overflow-hidden card">
                    ...
                    <div className='fluid-center profile-detail'>
                        ...
                        <div className='fluid-center btns-grp'>
                ...
                <div className='fluid-center fac-main '>
                    ...
                    <div className='fluid-center res-int-main f-d-c'>
