const sricData = {
    sric:[
        {
            id:1,
            title:'Recognition of IIIT Kalyani by Department of Scientific and Industrial Research',
            link:'/research/sric/272.2.5 Letterof Reco IIIT Kalyani.pdf'
        },
        {
            id:2,
            title:'Registration of IIIT Kalyani as a Research lnstitution',
            link:'/research/sric/272.2.5 RC IIIT Kalyani.pdf'
        }
    ],
    ongoing:[
        {
            id:1,
            title:'Performance Optimization and Security Enhancement in Networks with Co-Channel Interference',
            PI:'Dr. Pratik Chakraborty',
            value:'35 Lakhs',
            desc:'Sponsored by DST INSPIRE'
        },
        {
            id:2,
        ...
        },
        {
            ...
            value:'49.97 Lakhs',
            desc:'Sponsored by DRDO, Govt. of India'
        }
    ],
    completed:[
        {
            id:1,
            title:'Short-term Variability in Sun-Synchronous and Non-Sun Synchronous Tides in the Middle Atmosphere from Investigations of Contemporaneous Satellite, Model and Reanalysis Data',
            PI:'Dr. Uma Das',
            value:'20.3064 Lakhs',
        ...
        {
            id:2,
            title:'AI for Agriculture & Food Sustainability',
            PI:'Dr. Sanjay Chatterjee, Dr. Sanjoy Pratihar, and Dr. Imon Mukherjee',
            value:'16.18 Lakhs',
            desc:'Ministry of Electronics and Information Technology (MeitY), R&D in IT Group, ITEA Division, Govt. of India'
        },
        {
            id:3,
            title:' Design and Implementation of 2PAKA (two party authenticated key agreement) protocol for devices using Post -Quantum Cryptography',
            PI:'Dr SK Hafizul Islam',
            value:'4.9 Lakhs',
            desc:'Data Security Council of India (DSCI) sponsored project'
        },
        {
            id:4,
            title:'Investigation on the propagation characteristic of thermo-elastic wave in piezothermoelastic media',
            PI:'Dr Anirban Lakshman',
            value:'15.8656 Lakhs',
            desc:'SERB sponsored project SRG/2020/001141'
        },
        {
            id:5,
