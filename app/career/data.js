...
const careerData = {
    ...
    careerPDF:[
        {
            id:1,
            name:'Advertisement for Junior Technician (on contract) for Communication/Signal Processing Laboratory',
            link:'/career/Junior Technician.pdf',
            doc:''
        },
        {
            id:2,
    ...
    carrerForm:[
        {
            ...
            link:'/career/Form Junior Assistant.pdf',
            doc:''
        },
        {
            id:2,
            name:'JRF DRDO (CAIR) sponsored project',
            link:'/career/Form_for_JRF_Advertisement.pdf',
            doc:'/career/Form_for_JRF_Advertisement.docx'
        },
        {
            id:3,
            name:'Post of Registrar',
            link:'/career/assistant_registrar.pdf',
            doc:'/career/Application_form_Registrar.doc'
        },
        {
            id:4,
            name:'Admission to JRF Position',
            link:'/career/Form_for_JRF_Advertisement_g.pdf',
            doc:'/career/Form_for_JRF_Advertisement_g.docx'
        }
    ]
}
